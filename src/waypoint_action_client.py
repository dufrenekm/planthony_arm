...
class ExampleWaypointActionClient:
    ...
    def example_cartesian_waypoint_action(self):
        ...
        goal.trajectory.append(self.FillCartesianWaypoint(0.6,  0.0,   0.3,  math.radians(180), 0, math.radians(90), 0))
        goal.trajectory.append(self.FillCartesianWaypoint(0.6,  -.20,   0.3,  math.radians(180), 0, math.radians(90), 0))
        goal.trajectory.append(self.FillCartesianWaypoint(0.6,  .20,   0.3,  math.radians(180), 0, math.radians(90), 0))
        goal.trajectory.append(self.FillCartesianWaypoint(0.6,  0.0,   0.3,  math.radians(180), 0, math.radians(90), 0))
        goal.trajectory.append(self.FillCartesianWaypoint(0.7,  0.0,   0.2,  math.radians(180), 0, math.radians(90), 0))


        # First - x (+ towards testbed)
        # Second - y (+ to left testbed)
        # Third - z (+ upwards)
        # Fourth - end effector pitch (90 is horizontal, 0 is vertical up)
        # Fifth - end effector rotation (radians, 0 is straight. Positive is counterclockwise looking from arm)
        # Fifth - end effector yaw (radians, 90 is straight in x. Positive is countersclockwise looking from arm)
        '''
